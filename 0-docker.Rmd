...
> **Ejemplo** 
> Ejemplos de imágenes son `ubuntu` y la imagen de la clase con la que trabajaremos (`ITAM-DS/docker-ds`).
...
```
docker run -d -p 8787:8787 -p 8888:8888 -v path_a_carpeta:/home/itam/proyectos ITAM-DS/docker-ds
```
...
```
docker run  -it --user itam --name r-console -v path_a_carpeta:/home/itam/proyectos ITAM-DS/docker-ds /usr/bin/R
```

Lanzar la terminal de `python` con las librerías de cómputo científico:

```
docker run  -it --user itam --name ipython-console -v path_a_carpeta:/home/itam/proyectos ITAM-DS/docker-ds ipython
```

O un shell simple (en este caso `zsh`)

```
docker run -it --user itam  --name commandline -v path_a_carpeta:/home/itam/proyectos ITAM-DS/docker-ds /bin/zsh
```
